...
val test_1 = only_capitals ["a", "Bb", "cC"] = ["Bb"]

val test2 = longest_string1 ["A","bc","C"] = "bc"
val test2_1 = longest_string1 ["A", "bc", "BC", "C"] = "bc"
val test2_2 = longest_string1 [] = ""

val test3 = longest_string2 ["A","bc","C"] = "bc"
val test3_1 = longest_string2 ["A", "bc", "BC", "C"] = "BC"
val test3_2 = longest_string2 [] = ""

val test4a= longest_string3 ["A","bc","C"] = "bc"
val test4a_1 = longest_string3 ["A", "bc", "BC", "C"] = "bc"
val test4a_2 = longest_string3 [] = ""

val test4b= longest_string4 ["A","B","C"] = "C"
val test4b_1 = longest_string4 ["A", "bc", "BC", "C"] = "BC"
...
val test8_2 = all_answers (fn x => if x > 5 then SOME [x] else NONE) [2,3,4,5,6,7] = SOME [6,7]
...
val test9a_1 = count_wildcards(pattern3) = 3;
